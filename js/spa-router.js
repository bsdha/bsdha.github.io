(function () {
  ...
  const PATH_MAP = { '/': 'home', '/icd10': 'icd', '/icd10/': 'icd', '/thongkekcb-bvdkbdcs2': 'thongke', '/thongkekcb-bvdkbdcs2/': 'thongke', '/sinhhieu': 'sinhhieu', '/sinhhieu/': 'sinhhieu', '/insulin': 'insulin', '/insulin/': 'insulin', '/ldl': 'ldl', '/ldl/': 'ldl', '/egfr': 'egfr', '/egfr/': 'egfr', '/dichtruyen': 'dichtruyen', '/dichtruyen/': 'dichtruyen', '/bmi': 'bmi', '/bmi/': 'bmi', '/tuongtacthuoc': 'tuongtac', '/tuongtacthuoc/': 'tuongtac', '/donthuoc': 'donthuoc', '/donthuoc/': 'donthuoc', '/pdf2word': 'pdf2word', '/pdf2word/': 'pdf2word', '/pdftools': 'pdftools', '/pdftools/': 'pdftools', '/chuyentuyen': 'chuyentuyen', '/chuyentuyen/': 'chuyentuyen', '/nghiviecbhxh': 'nghiviecbhxh', '/nghiviecbhxh/': 'nghiviecbhxh', '/giayravien': 'giayravien', '/giayravien/': 'giayravien', '/ghepcccd': 'cccd', '/ghepcccd/': 'cccd', '/clinical-scores': 'clinicalscores', '/clinical-scores/': 'clinicalscores' };
  const KEY_PATH = { home: '/', icd: '/icd10', thongke: '/thongkekcb-bvdkbdcs2', sinhhieu: '/sinhhieu', insulin: '/insulin', ldl: '/ldl', egfr: '/egfr', dichtruyen: '/dichtruyen', bmi: '/bmi', tuongtac: '/tuongtacthuoc', donthuoc: '/donthuoc', pdf2word: '/pdf2word', pdftools: '/pdftools', chuyentuyen: '/chuyentuyen', nghiviecbhxh: '/nghiviecbhxh', giayravien: '/giayravien', cccd: '/ghepcccd', clinicalscores: '/clinical-scores' };
