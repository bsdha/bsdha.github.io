  ...
  const DEFAULT_OUTSIDE_DRUGS = (function () {
    const groups = {
      'Giảm đau - hạ sốt - kháng viêm': [
        ['Paracetamol', 'viên'], ['Ibuprofen', 'viên'], ['Diclofenac', 'viên'], ['Meloxicam', 'viên'],
        ['Celecoxib', 'viên'], ['Naproxen', 'viên'], ['Piroxicam', 'viên'], ['Aspirin', 'viên'],
        ['Tramadol', 'viên'], ['Paracetamol + Codein', 'viên'], ['Etoricoxib', 'viên'],
      ],
      'Kháng sinh': [
        ['Amoxicillin', 'viên'], ['Amoxicillin + Acid clavulanic', 'viên'], ['Ampicillin', 'viên'],
        ['Cephalexin', 'viên'], ['Cefuroxime', 'viên'], ['Cefixime', 'viên'], ['Cefpodoxime', 'viên'],
        ['Ceftriaxone', 'ống'], ['Azithromycin', 'viên'], ['Clarithromycin', 'viên'], ['Erythromycin', 'viên'],
        ['Doxycycline', 'viên'], ['Ciprofloxacin', 'viên'], ['Levofloxacin', 'viên'], ['Moxifloxacin', 'viên'],
        ['Metronidazole', 'viên'], ['Tinidazole', 'viên'], ['Clindamycin', 'viên'],
        ['Sulfamethoxazole + Trimethoprim (Cotrimoxazol)', 'viên'], ['Gentamicin', 'ống'], ['Vancomycin', 'lọ'],
      ],
      'Kháng virus - kháng nấm': [
        ['Acyclovir', 'viên'], ['Valacyclovir', 'viên'], ['Oseltamivir', 'viên'],
        ['Fluconazole', 'viên'], ['Itraconazole', 'viên'], ['Ketoconazole', 'viên'],
        ['Clotrimazole', 'tuýp'], ['Nystatin', 'viên'],
      ],
      'Tim mạch - huyết áp - mỡ máu': [
        ['Amlodipine', 'viên'], ['Nifedipine', 'viên'], ['Losartan', 'viên'], ['Valsartan', 'viên'],
        ['Telmisartan', 'viên'], ['Irbesartan', 'viên'], ['Candesartan', 'viên'], ['Perindopril', 'viên'],
        ['Enalapril', 'viên'], ['Lisinopril', 'viên'], ['Captopril', 'viên'], ['Bisoprolol', 'viên'],
        ['Metoprolol', 'viên'], ['Atenolol', 'viên'], ['Carvedilol', 'viên'], ['Nebivolol', 'viên'],
        ['Hydrochlorothiazide', 'viên'], ['Furosemide', 'viên'], ['Spironolactone', 'viên'],
        ['Indapamide', 'viên'], ['Digoxin', 'viên'], ['Amiodarone', 'viên'], ['Nitroglycerin', 'viên'],
        ['Isosorbide dinitrate', 'viên'], ['Clopidogrel', 'viên'], ['Atorvastatin', 'viên'],
        ['Rosuvastatin', 'viên'], ['Simvastatin', 'viên'], ['Fenofibrate', 'viên'],
      ],
      'Đái tháo đường': [
        ['Metformin', 'viên'], ['Gliclazide', 'viên'], ['Glimepiride', 'viên'], ['Glibenclamide', 'viên'],
        ['Sitagliptin', 'viên'], ['Vildagliptin', 'viên'], ['Linagliptin', 'viên'], ['Empagliflozin', 'viên'],
        ['Dapagliflozin', 'viên'], ['Acarbose', 'viên'], ['Pioglitazone', 'viên'], ['Insulin (các loại)', 'lọ'],
      ],
      'Tiêu hóa': [
        ['Omeprazole', 'viên'], ['Esomeprazole', 'viên'], ['Pantoprazole', 'viên'], ['Lansoprazole', 'viên'],
        ['Rabeprazole', 'viên'], ['Ranitidine', 'viên'], ['Domperidone', 'viên'], ['Metoclopramide', 'viên'],
        ['Sucralfate', 'gói'], ['Simethicone', 'viên'], ['Loperamide', 'viên'], ['Diosmectite (Smecta)', 'gói'],
        ['Bisacodyl', 'viên'], ['Lactulose', 'gói'], ['Mebeverine', 'viên'], ['Trimebutine', 'viên'],
        ['Alverine', 'viên'],
      ],
      'Hô hấp - dị ứng': [
        ['Salbutamol', 'viên'], ['Terbutaline', 'viên'], ['Budesonide (khí dung/xịt)', 'lọ'],
        ['Fluticasone (xịt)', 'lọ'], ['Ipratropium (khí dung)', 'lọ'], ['Theophylline', 'viên'],
        ['Montelukast', 'viên'], ['Bromhexine', 'viên'], ['Acetylcysteine', 'gói'], ['Ambroxol', 'viên'],
        ['Dextromethorphan', 'viên'], ['Chlorpheniramine', 'viên'], ['Loratadine', 'viên'],
        ['Cetirizine', 'viên'], ['Fexofenadine', 'viên'], ['Desloratadine', 'viên'],
      ],
      'Thần kinh - tâm thần - tuần hoàn não': [
        ['Gabapentin', 'viên'], ['Pregabalin', 'viên'], ['Amitriptyline', 'viên'], ['Sertraline', 'viên'],
        ['Fluoxetine', 'viên'], ['Escitalopram', 'viên'], ['Diazepam', 'viên'], ['Alprazolam', 'viên'],
        ['Clonazepam', 'viên'], ['Rotundin', 'viên'], ['Piracetam', 'viên'], ['Cinnarizine', 'viên'],
        ['Flunarizine', 'viên'], ['Betahistine', 'viên'], ['Vinpocetine', 'viên'], ['Citicoline', 'viên'],
      ],
      'Cơ xương khớp': [
        ['Glucosamine', 'viên'], ['Chondroitin', 'viên'], ['Eperisone', 'viên'], ['Tolperisone', 'viên'],
        ['Alendronate', 'viên'], ['Calcitriol', 'viên'],
      ],
      'Vitamin - khoáng chất': [
        ['Vitamin B1', 'viên'], ['Vitamin B6', 'viên'], ['Vitamin B12', 'viên'],
        ['Vitamin 3B (B1-B6-B12)', 'viên'], ['Vitamin C', 'viên'], ['Vitamin D3', 'viên'],
        ['Vitamin E', 'viên'], ['Calci carbonat', 'viên'], ['Sắt (Ferrous sulfat/fumarat)', 'viên'],
        ['Acid folic', 'viên'], ['Kẽm (Zinc gluconate)', 'viên'], ['Magie B6', 'viên'],
      ],
      'Da liễu - mắt - tai mũi họng': [
        ['Betamethasone (kem bôi)', 'tuýp'], ['Hydrocortisone (kem bôi)', 'tuýp'],
        ['Acid fusidic (kem bôi)', 'tuýp'], ['Chloramphenicol (nhỏ mắt)', 'lọ'],
        ['Tobramycin (nhỏ mắt)', 'lọ'], ['Natri clorid 0,9% (nước muối sinh lý)', 'chai'],
        ['Xylometazoline (nhỏ mũi)', 'chai'], ['Oxymetazoline (nhỏ mũi)', 'chai'],
      ],
      'Nội tiết - kháng viêm corticoid': [
        ['Levothyroxine', 'viên'], ['Thiamazole', 'viên'], ['Prednisolone', 'viên'],
        ['Methylprednisolone', 'viên'], ['Dexamethasone', 'viên'],
      ],
    };
    const out = [];
    Object.keys(groups).forEach((g) => {
      groups[g].forEach(([nm, form]) => out.push({ brand: nm, generic: nm, form, group: g }));
    });
    return out;
  })();
