(function () {
  ...
  // ---------- Upload Excel cho danh mục thuốc ----------
  // Đã chuyển sang trang quan-ly-ban-thuoc.html (mục "🏬 Kho thuốc") để gộp chung với
  // phần quản lý kho thuốc, cho nhất quán. Trang đó ghi thẳng vào bảng Supabase "thuoc"
  // (cho "Trong Bệnh viện") và vào localStorage key rxLocalDrugsOutside (cho "Ngoài Bệnh viện"),
  // cùng đúng định dạng mà loadDrugList()/loadOutsideDrugList() ở trên đọc ra.
